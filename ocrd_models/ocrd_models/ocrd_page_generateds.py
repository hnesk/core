...
#
# Generated Wed Jul 29 15:07:00 2020 by generateDS.py version 2.35.20.
...
#
# Command line:
#   /data/monorepo/ocrd_all/venv/bin/generateDS -f --root-element="PcGts" -o "ocrd_models/ocrd_models/ocrd_page_generateds.py" --export="etree" --disable-generatedssuper-lookup --user-methods="ocrd_models/ocrd_page_user_methods.py" ocrd_validators/ocrd_validators/page.xsd
#
